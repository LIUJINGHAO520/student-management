...
const handleLogin = () => {
  // 模拟登录验证
  if (loginUser.value === 'admin' && loginPwd.value === '123456') {
    ...
    <div v-else>
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-4 text-end">
          <button class="btn btn-outline-secondary" @click="handleLogout">退出登录</button>
        </div>
      </div>
